...
public class StanzaBloccataTest {
	...
	private StanzaProtected[] sequenzaStanze(String... stanza) {
		StanzaProtected[] elencoStanze = new StanzaProtected[stanza.length];
		for(int i = 0; i < stanza.length; i++)
			elencoStanze[i] = new StanzaProtected(stanza[i]) ;
	...
	public void testGetStanzaAdiacente_nonBloccata() {
		...
		StanzaProtected[] elencoStanze = sequenzaStanze("StanzaBloccata", "Stanza2", "Stanza3");
