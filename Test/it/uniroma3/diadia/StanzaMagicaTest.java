...
public class StanzaMagicaTest {
	private StanzaMagicaProtected stanza1;
	...
	public void setUpStanza() {
		this.stanza1 = new StanzaMagicaProtected("Stanza1");
	}
	...
	public void testAddAttrezzo_oggettoModificatoNome() {
		...
		assertEquals("adaps", stanza1.getAttrezzi()[3].getNome());
	}
	...
	public void testAddAttrezzo_oggettoModificatoPeso() {
		...
		stanza1.addAttrezzo(spada);
		assertEquals(10, stanza1.getAttrezzi()[3].getPeso());
	}
	...
	public void testAddAttrezzo_oggettoNonModificatoPeso() {
		...
		stanza1.addAttrezzo(spada);
		assertEquals(5, stanza1.getAttrezzi()[2].getPeso());
	}
	...
	public void testAddAttrezzo_oggettoNonModificatoNome() {
		...
		stanza1.addAttrezzo(spada);
		assertEquals("spada", stanza1.getAttrezzi()[2].getNome());
	}
