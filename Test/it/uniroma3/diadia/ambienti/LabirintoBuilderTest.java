...
public class LabirintoBuilderTest {
	...
	public void testBilocale() {
		...
		assertEquals(new ArrayList(Arrays.asList(Direzione.nord)),bilocale.getStanzaIniziale().getDirezioni());
		assertEquals(new ArrayList(Arrays.asList(Direzione.sud)),bilocale.getStanzaVincente().getDirezioni());
	}
	...
	public void testAggiuntaAttrezziAStanze_AppenaAggiunte() {
		...
		labirintoBuilder
				...
				.addAttrezzo(nomeAttrezzo, peso)
				.getLabirinto();
		assertTrue(labirintoBuilder.getListaStanze().get(nomeStanza).getAttrezzi().contains(new Attrezzo (nomeAttrezzo,peso)));
		assertEquals(new Attrezzo(nomeAttrezzo,peso),labirintoBuilder.getListaStanze().get(nomeStanza).getAttrezzo(nomeAttrezzo));
	}
	...
	public void testLabirintoCompletoConTutteLeStanze() {
		...
		Labirinto labirintoCompleto = this.labirintoBuilder
				...
				.addAdiacenza("corridoio bloccato", "Aula 1", Direzione.sud)
				.addAdiacenza("Aula 1", "corridoio bloccato", Direzione.sud)
				.addAdiacenza("Aula 1", nomeStanzaVincente,Direzione.sud)
